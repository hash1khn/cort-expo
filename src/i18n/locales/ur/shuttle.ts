export const shuttle = {
  rideInProgress: {
    ...
    arrivedAtOffice: '{{name}} پہنچ گئے — اتار دیا گیا',
    officeLabel: 'آفس',
  },
  routeDetails: {
  ...
  return: {
    ...
    markAllAttendance: 'شروع کرنے سے پہلے تمام حاضری درج کریں',
    markAllStopAttendance: 'آگے بڑھنے سے پہلے تمام حاضری درج کریں',
    confirmAttendanceProceed: 'حاضری کی تصدیق کریں اور آگے بڑھیں',
    officeAttendanceSubtitle: 'اس دفتر کے افراد کی حاضری یا غیر حاضری مقرر کریں',
