export const chauffeur = {
  ...
  incomingRequest: {
    ...
    acceptFailedTaken: 'This ride was just taken by another driver.',
    acceptFailedGeneric: 'Something went wrong. Please try again.',
    declineFailedGeneric: 'Could not decline this request. Please try again.',
  },
  nearbyRequests: {
    title: 'Nearby Requests',
    subtitle: 'Accept any request near you',
    loading: 'Finding requests near you…',
    couldNotLoad: 'Could not load nearby requests',
    retry: 'Retry',
    empty: 'No requests nearby right now',
    emptySubtitle: "We'll notify you as soon as a new request appears near you.",
    away: '{{distance}} km away',
    homeEntryLabel_one: '{{count}} ride request nearby',
    homeEntryLabel_other: '{{count}} ride requests nearby',
  },
  endRide: {
    title: 'End Ride',
